...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇs 🤖', url='https://t.me/Abcracked_movie'),
            InlineKeyboardButton('💥 ᴍᴏᴠɪᴇs ♥️', url='https://t.me/Abcracked'),
            ],[
            InlineKeyboardButton('💞 sᴜᴘᴘᴏʀᴛ 💞', url='https://t.me/Abcracked'),
            InlineKeyboardButton('👩‍💻 ʀᴇᴘᴏ ✨', url='soon'),
            ],[
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('ᴀᴍᴀᴢɪɴɢ ᴄᴏᴅᴇ ғʀᴏᴍ Abcracked')
